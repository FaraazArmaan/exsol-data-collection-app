...
import { marketingProduct } from './products-list/marketing';
import { ordersProduct } from './products-list/orders';
import { hrProduct } from './products-list/hr';
