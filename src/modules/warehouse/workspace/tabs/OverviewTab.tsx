...
// Stock & Locations: locations CRUD + stock-by-location + transfer. Every state
// handled: null = loading, [] = empty (prompt), error = dismissible banner.
export default function OverviewTab({ perms }: Props) {
