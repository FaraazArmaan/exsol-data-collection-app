...
| **Functions registered** | **~91 total** (88 after booking + 3 after File Manager Phase B: `files-quota`, `files-bulk`, `_shared/files-quota.ts` helper). Includes 1 scheduled function (`booking-pending-cleanup`, `*/5 * * * *`) |
